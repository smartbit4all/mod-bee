...
public class Statistics extends ViewFrame {
  ...
  public Statistics(StatDataService statDataService) {
  ...
  private Component createContent() {
    ...
    FlexBoxLayout content = new FlexBoxLayout(
        new Div(new Label("No. of events: " + statDataService.getNoOfAllEvents(null, null))),
        payments, transactions, docs);
  ...
  private Component createPayments() {
    FlexBoxLayout payments =
        new FlexBoxLayout(createHeader(VaadinIcon.CREDIT_CARD, "Payments"), createPaymentsCharts());
  ...
  private Component createPaymentChart(Payment.Status status) {
    ...
    FlexBoxLayout textContainer = new FlexBoxLayout(UIUtils.createH2Label(Integer.toString(value)),
  ...
  private Component createTransactions() {
    FlexBoxLayout transactions = new FlexBoxLayout(
        createHeader(VaadinIcon.MONEY_EXCHANGE, "Transactions"), createAreaChart());
  ...
  private Component createAreaChart() {
    ...
    xAxis.setCategories("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov",
        "Dec");
    conf.addxAxis(xAxis);
  ...
  private Component createReports() {
    ...
    Div items = new Div(
        new ListItem(UIUtils.createIcon(IconSize.M, TextColor.TERTIARY, VaadinIcon.CHART),
            "Weekly Report", "Generated Oct 5, 2018", createInfoButton()),
        new ListItem(UIUtils.createIcon(IconSize.M, TextColor.TERTIARY, VaadinIcon.SITEMAP),
            "Payment Workflows", "Last modified Oct 24, 2018", createInfoButton()));
  ...
  private Component createLogs() {
    ...
    Div items = new Div(
        new ListItem(UIUtils.createIcon(IconSize.M, TextColor.TERTIARY, VaadinIcon.EXCHANGE),
            "Transfers (October)", "Generated Oct 31, 2018", createInfoButton()),
        new ListItem(UIUtils.createIcon(IconSize.M, TextColor.TERTIARY, VaadinIcon.SHIELD),
            "Security Log", "Updated 16:31 CET", createInfoButton()));
    items.addClassNames(LumoStyles.Padding.Vertical.S);
