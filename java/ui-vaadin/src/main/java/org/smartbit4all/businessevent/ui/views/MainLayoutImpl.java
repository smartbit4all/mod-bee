package org.smartbit4all.businessevent.ui.views;
...
@Push
@UIScope
public class MainLayoutImpl extends FlexBoxLayout
    implements MainLayout, RouterLayout, PageConfigurator, AfterNavigationObserver {

  private static final Logger log = LoggerFactory.getLogger(MainLayoutImpl.class);
  ...
  private void initNaviItems() {
    ...
    menu.addNaviItem(VaadinIcon.CHART, getTranslation("menu.statistics"), DashBoard.class);
